...
dataloader = DataLoader('data/AtoA/DCS/o_a2.txt', return_label=True)
# 初始化火控系统，在任务开始之前进行
fire = AtoA(mode='online', seed=2020, type='dcs')
# 加载训练好的模型
model = fire.load_model('AtoA_dcs_offline_lgb_hold-out/lgb_hold-out_0.05.pkl')
threshold = 0.05
